...
/**
 * ╔══════════════════════════════════════════════╗
 *   Mini Pascal Editor  — Editor de Código
 *   Funcionalidades:
 *   - Editar, Salvar, Abrir, Salvar Como
 *   - Numeração de linhas sincronizada
 *   - Copiar, Recortar, Colar, Desfazer, Refazer
 *   - 5 Temas visuais (Escuro, Claro, Monokai, Solarized, Midnight)
 *   - Escolha de fonte e tamanho
 *   - Barra de status com linha/coluna
 *   - Indicador de modificação no título
 * ╚══════════════════════════════════════════════╝
 */
public class MiniPascalEditor extends JFrame {
    ...
    // CONSTRUÇÃO
    // ═══════════════════════════════════════════════════════════════════════
    public MiniPascalEditor() {
        super("Mini Pascal Editor");
    ...
    private JPanel buildToolbar() {
        ...
        tb.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0, Color.GRAY));
        ...
        themeLabel = new JLabel("  Tema: Dark ");
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // PAINEL DE NÚMEROS DE LINHA (componente personalizado)
    // ═══════════════════════════════════════════════════════════════════════
    ...
    private JPanel buildStatusBar() {
        ...
        rightPanel.add(new JSeparator(JSeparator.VERTICAL) {{ setPreferredSize(new Dimension(1, 14)); }});
    ...
    private void updateTitle() {
        ...
        String mod  = modified ? " ●" : "";
        setTitle("Mini Pascal Editor — " + nome + mod);
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(MiniPascalEditor::new);
    }
}